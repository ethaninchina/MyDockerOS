...
[{rabbit,[{vm_memory_high_watermark,0.4},{vm_memory_high_watermark_paging_ratio, 0.8},{disk_free_limit, "5GB"},{hipe_compile, true},{cluster_partition_handling, autoheal}]}].
EOF
